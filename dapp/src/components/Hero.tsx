...
export default function Hero() {
  return (
    <section className="text-center py-10 px-4 bg-primary-light">
      <div className="max-w-4xl mx-auto">
        <div className="relative w-32 h-32 mx-auto mb-6">
          <Image src="/lobster.png" className="border border-primary rounded-lg  bg-white" alt="Lobster" layout="fill" objectFit="contain" />
        </div>
        ...
        <p className="text-lg sm:text-lg text-text-light max-w-2xl mx-auto">
          Take some time out of your busy schedule and catch some onchain lobsters with friends.<br></br> Relax & enjoy.
        </p>
        {/* <div className="mt-8">
          <a
            href="#start-fishing"
